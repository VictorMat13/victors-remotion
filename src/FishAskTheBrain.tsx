...
// -------------------------------------------------------------------------
// Demo beat: Victor asks the second brain a question (purple listening /
// thinking state, ~5s of space), then the voice agent answers in the amber
// voice-orb style with the real answer audio driving the visualizer.
// -------------------------------------------------------------------------
const AUDIO_SRC = "fish-audio/proposal-answer.mp3";
const FPS = 30;
const AUDIO_START = 152; // ~5s of listening space first
const TAIL_PAD = 26;
const PLACEHOLDER_AUDIO_SEC = 4.1;
...
export const calculateAskTheBrainMetadata = async ({
  props,
}: {
  props: Props;
}) => {
...
export const FishAskTheBrain: React.FC<Props> = ({ hasAudio, audioFrames }) => {
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg }}>
      {hasAudio ? (
